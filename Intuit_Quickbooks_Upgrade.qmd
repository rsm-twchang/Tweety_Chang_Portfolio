...
| zip_bins | response_rate (`res1_yes`) | n |
|---:|---:|---:|
| 1  | 0.218525 | 3757 |
| 18 | 0.051934 | 3774 |
| 12 | 0.049281 | 3754 |
...
### Drill-down: ZIP5 within `zip_bins = 1`
...
### Confirmation: ZIP-level anomalies are limited to 00801 and 00804
...
**Decision.** These two ZIP codes are treated as a distinct segment in modeling through an indicator feature.
...
### Baseline model comparison: effect of `isweird`
...
### Baseline logistic regression (LR1): drivers and fit
...
#### Predictors associated with higher response odds (LR1)
...
#### Limited or non-significant effects (LR1)
...
![Figure 2. LR1 permutation importance (AUC decrease)](figures/fig2_lr1_permutation_importance.png){#fig-lr1-permimp}
...
### Enhanced logistic regression (LR2): isolating anomalous ZIP behavior
...
### Consolidating version1 and upgraded into Version Path Segments
...
### Product version path: defining `version_upgrade`
...
### Baseline benchmark: mail-to-all strategy
...
### Neural network check (MLP, single hidden unit)
...
### Interaction checks informed by deeper MLP behavior
...
### Logistic regression with interaction terms (LR3)
...
### Neural network final model (MLP1): tuned configuration
...
### Final model interpretation (MLP1)
