...
![Figure 1. Distribution of Patent Counts by Blueprinty Usage](figures/fig1_blueprinty_patent_hist.png){#fig-blueprinty-hist}
...
![Figure 2. Poisson Log-Likelihood vs. Lambda](figures/fig2_poisson_loglik_vs_lambda.png){#fig-poisson-loglik}
...
![Figure 3. Poisson Regression Coefficients (95% CI)](figures/fig3_poisson_coef_plot.png){#fig-poisson-coefs}
...
![Figure 4. Predicted Patents by Blueprinty Usage](figures/fig4_predicted_patents.png){#fig-predicted-patents}
